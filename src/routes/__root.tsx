...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered emergency response platform connecting accident victims with hospitals, ambulances, police and rescue networks in real time." },
      { name: "author", content: "RoadSoS AI" },
      { property: "og:title", content: "RoadSoS AI — Smart Emergency Rescue Network" },
      { property: "og:description", content: "Futuristic AI emergency rescue dashboard reducing road accident response time." },
